...
st.markdown(
    """
    <div style="text-align: center; margin-bottom: 10px;">
        <p style="font-size: 32px; font-weight: bold;">Dashboard Financeiro:</p>
        <p style="font-size: 16px;"> 
        Utilizando DAX para calculos de métricas: Faturamento, Margem, Imposto, Lucro.
        </p>
    </div>
    """,
    unsafe_allow_html=True
...
st.markdown(
    """
    <div style="display: flex; justify-content: center;">
        <iframe title="Dashboard-Financeiro" width="1000" height="450" src="https://app.powerbi.com/view?r=eyJrIjoiNzg2MjBlMGMtZTg5YS00YWI1LWFiZGItOGI3ZDQ5MTA5MTYwIiwidCI6Ijk4YTQ3YjdhLTBjMzYtNGUyNy04MGE3LTZjMDU2YzdjMWI0NCJ9" frameborder="0" allowFullScreen="true"></iframe>
    </div>
    """,
    unsafe_allow_html=True
)
